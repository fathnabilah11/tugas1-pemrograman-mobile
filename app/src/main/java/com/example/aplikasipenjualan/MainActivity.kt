...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "BRANI CLOTHES"
        ...
        btnproses!!.setOnClickListener {
            ...
            if (total >= 150000) {
                txtbonus!!.text = "Bonus : Kaos Eksklusif"
            } else if (total >= 130000) {
                txtbonus!!.text = "Bonus : Permainan Kartu"
            } else if (total >= 100000) {
                txtbonus!!.text = "Bonus : Gantungan Kunci"
            } else {
            ...
            if (ub < total) {
                ...
                txtketerangan!!.text = "Keterangan : Tidak Ada Kembalian"
                txtuangkembali!!.text = "Uang Kembali : Rp 0"
            } else {
